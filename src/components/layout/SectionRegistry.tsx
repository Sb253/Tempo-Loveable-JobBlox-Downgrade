...
const CustomerList = React.lazy(() =>
  import("../CustomerList").then((m) => ({ default: m.CustomerList })),
);
const CustomerForm = React.lazy(() =>
  import("../CustomerForm").then((m) => ({ default: m.CustomerForm })),
);
const JobList = React.lazy(() =>
  import("../JobList").then((m) => ({ default: m.JobList })),
);
const JobForm = React.lazy(() =>
  import("../JobForm").then((m) => ({ default: m.JobForm })),
);
const EstimateList = React.lazy(() =>
  import("../EstimateList").then((m) => ({ default: m.EstimateList })),
);
...
const ExpenseList = React.lazy(() =>
  import("../ExpenseList").then((m) => ({ default: m.ExpenseList })),
);
const TimeTracking = React.lazy(() =>
  import("../TimeTracking").then((m) => ({ default: m.TimeTracking })),
);
const MaterialsAndServices = React.lazy(() =>
  import("../MaterialsAndServices").then((m) => ({
    default: m.MaterialsAndServices,
  })),
);
const MaterialInventory = React.lazy(() =>
  import("../MaterialInventory").then((m) => ({
    default: m.MaterialInventory,
  })),
);
const EquipmentTracking = React.lazy(() =>
  import("../EquipmentTracking").then((m) => ({
    default: m.EquipmentTracking,
  })),
);
const PhotoDocumentation = React.lazy(() =>
  import("../PhotoDocumentation").then((m) => ({
    default: m.PhotoDocumentation,
  })),
);
const ReviewManagement = React.lazy(() =>
  import("../ReviewManagement").then((m) => ({ default: m.ReviewManagement })),
);
const SafetyManagement = React.lazy(() =>
  import("../SafetyManagement").then((m) => ({ default: m.SafetyManagement })),
);
const QualityControl = React.lazy(() =>
  import("../QualityControl").then((m) => ({ default: m.QualityControl })),
);
const VehicleManagement = React.lazy(() =>
  import("../VehicleManagement").then((m) => ({
    default: m.VehicleManagement,
  })),
);
const LocationManagement = React.lazy(() =>
  import("../LocationManagement").then((m) => ({
...
const TaxAndFinancialSection = React.lazy(() =>
  import("../TaxAndFinancialSection").then((m) => ({
    default: m.TaxAndFinancialSection,
  })),
);
...
const TeamManagement = React.lazy(() =>
  import("../TeamManagement").then((m) => ({ default: m.TeamManagement })),
);
const HRFeatures = React.lazy(() =>
  import("../HRFeatures").then((m) => ({ default: m.HRFeatures })),
);
const SubcontractorManagement = React.lazy(() =>
  import("../SubcontractorManagement").then((m) => ({
    default: m.SubcontractorManagement,
  })),
);
const MobileSettings = React.lazy(() =>
  import("../MobileSettings").then((m) => ({ default: m.MobileSettings })),
);
const CompanySettings = React.lazy(() =>
  import("../CompanySettings").then((m) => ({ default: m.CompanySettings })),
);
const BranchManagement = React.lazy(() =>
  import("../BranchManagement").then((m) => ({ default: m.BranchManagement })),
);
...
const RealTimeChat = React.lazy(() =>
  import("../RealTimeChat").then((m) => ({ default: m.RealTimeChat })),
);
const AdvancedInventorySystem = React.lazy(() =>
  import("../AdvancedInventorySystem").then((m) => ({
    default: m.AdvancedInventorySystem,
  })),
);
const FinancialAnalyticsDashboard = React.lazy(() =>
  import("../FinancialAnalyticsDashboard").then((m) => ({
    default: m.FinancialAnalyticsDashboard,
  })),
);
const PaymentIntegrationHub = React.lazy(() =>
  import("../PaymentIntegrationHub").then((m) => ({
    default: m.PaymentIntegrationHub,
  })),
);
const ProfitMarginAnalysis = React.lazy(() =>
  import("../ProfitMarginAnalysis").then((m) => ({
    default: m.ProfitMarginAnalysis,
  })),
);
const PredictiveAnalyticsDashboard = React.lazy(() =>
  import("../PredictiveAnalyticsDashboard").then((m) => ({
    default: m.PredictiveAnalyticsDashboard,
  })),
);
const AdvancedReporting = React.lazy(() =>
  import("../AdvancedReporting").then((m) => ({
    default: m.AdvancedReporting,
  })),
);
const QuickBooksIntegration = React.lazy(() =>
  import("../QuickBooksIntegration").then((m) => ({
    default: m.QuickBooksIntegration,
  })),
);
const AccountingIntegration = React.lazy(() =>
  import("../AccountingIntegration").then((m) => ({
    default: m.AccountingIntegration,
  })),
);
const RadiusAssignment = React.lazy(() =>
  import("../RadiusAssignment").then((m) => ({ default: m.RadiusAssignment })),
);
const EmployeeLocationManager = React.lazy(() =>
  import("../EmployeeLocationManager").then((m) => ({
    default: m.EmployeeLocationManager,
  })),
);
const EnhancedAIChatAssistant = React.lazy(() =>
  import("../EnhancedAIChatAssistant").then((m) => ({
    default: m.EnhancedAIChatAssistant,
  })),
);
const EnhancedSmartDocumentGenerator = React.lazy(() =>
  import("../EnhancedSmartDocumentGenerator").then((m) => ({
    default: m.EnhancedSmartDocumentGenerator,
  })),
);
const EnhancedAISettings = React.lazy(() =>
  import("../EnhancedAISettings").then((m) => ({
    default: m.EnhancedAISettings,
  })),
);
const ClientAppointment = React.lazy(() =>
  import("../ClientAppointment").then((m) => ({
    default: m.ClientAppointment,
  })),
);
...
const AdvancedAnalytics = React.lazy(() =>
  import("../AdvancedAnalytics").then((m) => ({
...
export const createSectionRegistry = () => {
  ...
  return {
    ...
    "customer-form": (
      <CustomerForm onClose={() => console.log("Customer form closed")} />
    ),
    pipeline: <Pipeline />,
