                  ...
                  {(provided, snapshot) => (
                    <Card
                      ...
                      className={`transition-all duration-200 ${
                        snapshot.isDragging ? 'shadow-xl scale-105 rotate-1' : 'shadow-sm hover:shadow-md'
                      } bg-gradient-to-br from-card to-card/50 border-2 border-primary/10`}
                    >
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Select
                                value={widget.style}
                                onValueChange={(value: 'default' | 'gradient' | 'minimal' | 'bordered') => 
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                ...
                                onChange={(e) => updateWidget(widget.id, { refreshInterval: parseInt(e.target.value) })}
                                className="w-16 h-8"
                                min="5"
                                max="300"
                              />
