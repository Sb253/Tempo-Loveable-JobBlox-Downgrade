              ...
              >
                <Popup>
                  <div style={{ padding: '8px', maxWidth: '200px' }}>
                    <h3 style={{ fontWeight: 'bold', margin: '0 0 8px 0' }}>{job.title}</h3>
                    <p style={{ margin: '4px 0', color: '#666', fontSize: '14px' }}>{job.customer}</p>
                    <p style={{ margin: '4px 0', fontSize: '14px' }}>{job.address}</p>
                    <span style={{
