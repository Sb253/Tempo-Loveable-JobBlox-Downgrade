...
// Drag and drop functionality temporarily disabled due to missing dependency
...
const employeeLocations = [
  {
    id: "1",
    name: "Mike Johnson",
    coordinates: [-74.005, 40.7138] as [number, number],
    color: "#3B82F6",
  ...
  },
  {
    id: "2",
    name: "Sarah Davis",
    coordinates: [-73.998, 40.7158] as [number, number],
    color: "#10B981",
    status: "active" as const,
  },
  {
  ...
  },
  {
    id: "4",
    name: "Lisa Chen",
    coordinates: [-74.012, 40.7088] as [number, number],
    color: "#8B5CF6",
    status: "active" as const,
  },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${gradientColors[index]} opacity-10`}
                    ></div>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                      ...
                      <div
                        className={`p-2 rounded-lg bg-gradient-to-br ${gradientColors[index]}`}
                      >
                  ...
                  <div className="space-y-4">
                    {recentJobs.map((job) => {
                      ...
                      return (
                        <div
                          key={job.id}
                          className="flex justify-between items-center p-3 border rounded-lg bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900"
                        >
                          <div className="flex items-center gap-3">
                            <div
                              className="w-3 h-3 rounded-full"
                          ...
                          <span
                            className={`text-xs px-3 py-1 rounded-full bg-gradient-to-r ${statusColors[job.status]} text-white font-medium`}
                          >
        ...
        {isEditingDashboard ? (
          <div className="space-y-6">
            {widgets.map((widget, index) => (
              <div
                key={widget.id}
                className={`border-2 border-dashed rounded-lg p-4 border-muted ${widget.id === "stats" ? "opacity-50" : ""}`}
              >
          ...
          <div className="space-y-6">
            {enabledWidgets.map((widget) => (
              <div key={widget.id}>{getWidget(widget.id)}</div>
            ))}
          </div>
        )}
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2 pt-4">
                  ...
                  <Button onClick={handleTimezoneUpdate}>Save Changes</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
